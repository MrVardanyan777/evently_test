...
const Collection = ( { data, emptyTitle, emptyStateSubtext, page, totalPage = 0, limit, collectionType, urlParamName } : CollectionType ) => {
  return (
    <>
       {data.length > 0 ? (
        <div className='flex flex-col items-center gap-10'>
          <ul className='grid w-full grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:gap-10'>
            ...
            {totalPage > 1 && (
              <Pagination urlParamName={urlParamName} page={page} totalPages={totalPage} />
            )}
